...
def write_report(out: Path, meta, regressions, thresholds, distribution, selected, national):
    ...
    methods = [
        ...
        "Состав клиентов и регионы сверены с client_week_panel_v2.csv, каждый клиент-месяц — с fines_clean.csv и fuel_clean.csv. "
    ...
    sections = [
        ...
        ("Архив и воспроизводимость", "monthly_risk_analysis переименована в archive_monthly_risk_clustering. "
         ...
         "Новый запуск: .venv/bin/python -m fines_per_liter_analysis.run_analysis. "
